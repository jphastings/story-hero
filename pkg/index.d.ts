...
declare global {
  ...
  // A convenience method that returns the number of songs in this story with a best score (across instruments) equal to (only: true) or equal/greater than (only: false) the number provided
  function countMeetingScore(score: number, only: boolean): number
  // A convenience method that returns the number of songs in this story with a best percentage (across instruments) equal to (only: true) or equal/greater than (only: false) the number provided
  function countMeetingPercentage(score: number, only: boolean): number
  // A convenience method that returns the number of songs in this story with best stars (across instruments) equal to (only: true) or equal/greater than (only: false) the number provided
